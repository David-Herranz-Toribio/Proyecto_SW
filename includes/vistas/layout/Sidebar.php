    ...
    <dl class= "opciones">
        <dt class="perfil_shortcut">
            ...
            <details>
                ...
                <dd><a href="<?=VIEWS_PATH?>/perfil/Perfil.php?favs=1">Posts Favoritos</a></dd>
        ...
        <dt class="foro_shorcut">
            ...
            <!--  <details>
                ...
                <dd><a href="<?=VIEWS_PATH?>/foro/CrearPost.php">Publicar post</a></dd>
            </details> -->
        </dt>
        ...
        <details>
            ...
            <dd><a href="<?=VIEWS_PATH?>/tienda/Entradas.php"><img src="<?=IMG_PATH?>/FotoEntrada.png" height="50" width="50" alt="Foto de eventos"></a></dd>
            <dd><a href="<?=VIEWS_PATH?>/tienda/Merch.php"><img src="<?=IMG_PATH?>/FotoMerch.png" height="50" width="50" alt="Foto de merchandising"></a></dd>
            <dd><a href="<?=VIEWS_PATH?>/tienda/Carrito.php"><img src="<?=IMG_PATH?>/FotoCarrito.png" height="50" width="50" alt="Foto de mi carrito"></a></dd>
        </details>
        </dt>
    </dl>
</nav>